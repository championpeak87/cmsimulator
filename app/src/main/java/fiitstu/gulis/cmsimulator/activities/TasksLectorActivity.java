 ...
 */
public class TasksLectorActivity extends FragmentActivity implements ExampleTaskDialog.ExampleTaskDialogListener, TasksGameDialog.TasksGameDialogListener {

    //log tag
    private static final String TAG = TasksLectorActivity.class.getName();
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_tasks_lector);
        ...
        example.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (loggedUser == null) {
                    Toast.makeText(TasksLectorActivity.this, R.string.logged_out, Toast.LENGTH_LONG).show();
                    TasksLectorActivity.this.finish();
                } else {
                    Intent nextActivityIntent = new Intent(TasksLectorActivity.this, EditTaskActivity.class);
        ...
        findAutomataTasks.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (loggedUser == null)
                {
                    ...
                    Intent intent = new Intent(TasksLectorActivity.this, BrowseAutomataTasksActivity.class);
    ...
    private void loadTask() {
        ...
        fileSelector.setFileSelectedListener(new FileSelector.FileSelectedListener() {
            ...
            public void onFileSelected(String filePath, FileHandler.Format format) {
                ...
                try {
                    ...
                    Toast.makeText(TasksLectorActivity.this, getResources().getString(R.string.file_not_loaded), Toast.LENGTH_SHORT).show();
                }
            }
        });
        ...
        fileSelector.selectFile(TasksLectorActivity.this);
    }
    ...
    public void tasksGameDialogClick(String assetName) {
        ...
        Intent automata = new Intent(TasksLectorActivity.this, SimulationActivity.class);
