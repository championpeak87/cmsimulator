...
public class FiniteAutomataTask extends Task {
    ...
    public FiniteAutomataTask(String title, String text, Time available_time, Time remaining_time, String assigner, int task_id, boolean public_inputs, Task.TASK_STATUS status) {
