...
public class PushdownAutomataTask extends Task {
    public PushdownAutomataTask(String title, String text, Time available_time, String assigner, int task_id, boolean public_inputs, Task.TASK_STATUS status) {
        super(title, text, available_time, assigner, task_id);
        this.setPublicInputs(public_inputs);
        this.setStatus(status);
    }

    public PushdownAutomataTask(String title, String text, Time available_time, Time remaining_time, String assigner, int task_id, boolean public_inputs, Task.TASK_STATUS status, Date submissionDate) {
