...
public class TuringMachineTask extends Task {
    ...
    public TuringMachineTask(String title, String text, Time available_time, Time remaining_time, String assigner, int task_id, boolean public_inputs, Task.TASK_STATUS status, Date submissionDate) {
