...
public class TuringMachineTask extends AutomataTask {
    public TuringMachineTask(String task_name, String task_description, int task_id, String file_name, deterministic determinism) {
